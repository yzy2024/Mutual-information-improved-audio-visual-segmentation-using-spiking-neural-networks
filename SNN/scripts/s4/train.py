...
from scripts.s4.loss import IouSemanticAwareLoss
...
def main():
    ...
    # model.load_state_dict(torch.load("/home/songyu/vit-llm/yzy/MI_AVS/work_dir/AVSegFormer_pvt2_s4/s4_best.pth"))
    # model.load_state_dict(torch.load("/home/songyu/vit-llm/yzy/MI_AVS_Spike/work_dir/AVSegFormer_pvt2_s4/s4_best.pth"))
    ...
    for epoch in range(cfg.process.train_epochs):
        ...
        for n_iter, batch_data in enumerate(train_dataloader):
            ...
            output, mask_feature, mi_map = model(audio, imgs)  # [bs*5, 1, 224, 224]
            loss, loss_dict = IouSemanticAwareLoss(
                output, mask_feature, mi_map, mask.unsqueeze(1).unsqueeze(1), **cfg.loss)
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--cfg', type=str, default='/data1/xiao_Audio_Visual/MI_AVS/config/s4/AVSegFormer_pvt2_s4.py', help='config file path')
    # parser.add_argument('--log_dir', type=str,
    #                     default='/data1/xiao_Audio_Visual/MI_AVS/work_dir', help='log dir')
    # parser.add_argument('--checkpoint_dir', type=str,
    #                     default='/data1/xiao_Audio_Visual/MI_AVS/work_dir', help='dir to save checkpoints')
    # parser.add_argument("--session_name", default="s4",
    #                     type=str, help="the S4 setting")
    parser.add_argument('--cfg', type=str, default='/home/songyu/vit-llm/yzy/MI_AVS_Spike/config/s4/AVSegFormer_pvt2_s4.py', help='config file path')
    parser.add_argument('--log_dir', type=str,
                        default='/home/songyu/vit-llm/yzy/MI_AVS_Spike/new_result', help='log dir')
    parser.add_argument('--checkpoint_dir', type=str,
                        default='/home/songyu/vit-llm/yzy/MI_AVS_Spike/new_result', help='dir to save checkpoints')
    parser.add_argument("--session_name", default="s4",
                        type=str, help="the S4 setting")
