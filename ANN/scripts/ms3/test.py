...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default="/home/songyu/vit-llm/yzy/MI_AVS/config/ms3/AVSegFormer_pvt2_ms3.py", help='config file path')
    parser.add_argument('--weights', type=str, default="/home/songyu/vit-llm/yzy/MI_AVS/ms3_work_dir/AVSegFormer_pvt2_ms3/ms3_best.pth", help='model weights path')
