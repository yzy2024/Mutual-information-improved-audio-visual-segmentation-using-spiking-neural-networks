    ...
    with torch.no_grad():
        for n_iter, batch_data in enumerate(test_dataloader):
            ...
            if args.save_pred_mask:
                ...
                save_mi_visualization(mi, mi_save_path, expanded_video_names)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/songyu/vit-llm/yzy/MI_AVS/work_dir/AVSegFormer_pvt2_s4/s4_best.pth', help='model weights path')
    parser.add_argument("--save_pred_mask", action='store_true',
                        default=True, help="save predited masks or not")
    parser.add_argument('--save_dir', type=str,
                        default='work_dir/1', help='save path')
