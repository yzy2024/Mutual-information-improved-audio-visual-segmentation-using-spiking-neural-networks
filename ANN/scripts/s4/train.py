...
def main():
    ...
    # model.load_state_dict(torch.load("/home/songyu/vit-llm/zhenyu/work_dir/AVSegFormer_pvt2_s4/s4_best.pth"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/songyu/vit-llm/yzy/MI_AVS/config/s4/AVSegFormer_pvt2_s4.py', help='config file path')
    parser.add_argument('--log_dir', type=str,
                        default='/home/songyu/vit-llm/yzy/MI_AVS/work_dir_s4wol', help='log dir')
    parser.add_argument('--checkpoint_dir', type=str,
                        default='/home/songyu/vit-llm/yzy/MI_AVS/work_dir_s4wol', help='dir to save checkpoints')
